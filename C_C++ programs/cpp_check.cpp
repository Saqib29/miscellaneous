...
int winner()
{
   ...
   if(board[0][2] == board[1][1] && board[1][1] == board[2][1]) return current_player;
...
void game()
{
    ...
    for(int i=0; i<9; i++)
    {
        ...
        if(player_won == 1) { cout << "Player one won! congratulations!\n"; break; }
        if(player_won == 2){ cout << "Player two won! congratulations!\n"; break; }
